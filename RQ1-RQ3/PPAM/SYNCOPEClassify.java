...
public class SYNCOPEClassify {

   public static void main(String[] args) throws Exception{
      DataSource sourceTrain = new DataSource("PPAMs/SYNCOPEPPAMTrainSet.csv");
      DataSource sourceTest = new DataSource("PPAMs/SYNCOPEPPAMTestSet.csv");
