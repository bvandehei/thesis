...
public class LOG4J2Classify {

   public static void main(String[] args) throws Exception{
      DataSource sourceTrain = new DataSource("PPAMs/LOG4J2PPAMTrainSet.csv");
      DataSource sourceTest = new DataSource("PPAMs/LOG4J2PPAMTestSet.csv");
