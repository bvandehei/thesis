...
public class DIRSTUDIOClassify {

   public static void main(String[] args) throws Exception{
      DataSource sourceTrain = new DataSource("PPAMs/DIRSTUDIOPPAMTrainSet.csv");
      DataSource sourceTest = new DataSource("PPAMs/DIRSTUDIOPPAMTestSet.csv");
