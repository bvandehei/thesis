...
public class ISISClassify {

   public static void main(String[] args) throws Exception{
      DataSource sourceTrain = new DataSource("PPAMs/ISISPPAMTrainSet.csv");
      DataSource sourceTest = new DataSource("PPAMs/ISISPPAMTestSet.csv");
