...
public class XERCESJClassify {

   public static void main(String[] args) throws Exception{
      DataSource sourceTrain = new DataSource("PPAMs/XERCESJPPAMTrainSet.csv");
      DataSource sourceTest = new DataSource("PPAMs/XERCESJPPAMTestSet.csv");
