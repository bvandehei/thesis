   ...
   public static void main(String[] args) throws IOException {
      ...
      try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
         ...
         try {
            ...
            //Header for CSV
            fileWriter.append("Project Key,Bug ID,Bug Order,Version ID,Version Name,Simple,LAV,Merge,Actual Bugginess");
            fileWriter.append("\n");
            ...
            while ( (linefromcsv = br.readLine()) != null) {
               ...
               for ( i = (totalBugs / 2); i <= totalBugs; i++) {
                  for (j = 1 ; j <= BugAndFix.get(i); j++) {
                     String simple, LAVbuggy, merge, actual;
