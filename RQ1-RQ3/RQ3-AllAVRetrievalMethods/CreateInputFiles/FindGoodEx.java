...
public class FindGoodEx {
  ...
  //Adds a release to the arraylist
   ...
   public static void main(String[] args) throws IOException, JSONException {
      String csvFile = "OrderedBugOutputFiles/AMQCPPBugInfoOrdered.csv";
      String cvsSplitBy = ",";
      Integer i, j, t;
...
br.readLine();
         while ( (linefromcsv = br.readLine()) != null) {
               ...
               Integer firstAV = Integer.parseInt(token[3]);
               Integer created = Integer.parseInt(token[4]);
               Integer fix = Integer.parseInt(token[5]);
               if (firstAV < created && created < fix) {
String url = "https://issues.apache.org/jira/rest/api/2/issue/" + bugID;
         JSONObject json = readJsonFromUrl(url);
         JSONArray versions = json.getJSONObject("fields").getJSONArray("versions");
if ( versions.length() == (fix - firstAV))
