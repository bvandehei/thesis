     ...
     try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
         ...
         try {
            //Name of CSV for output
				    fileWriter = new FileWriter("BlamerResults.csv");
				    fileWriter2 = new FileWriter("BlamerStatistics.csv");
            //Header for CSV
            fileWriter.append("Project Key,Bug ID,Bug Order,Version ID,Version Name," +
                              "Simple,Proportion0.5,Proportion1,Proportion2,Merge," +
            ...
            while ( (linefromcsv = br.readLine()) != null) {
               ...
               String hashfilename = "CreateInputFiles/CSVFiles/"+ token[0] + "BugInfo.csv";
               ...
               for (int h = 1; h < token.length; h++) {
                  ...
                  try (BufferedReader brHash = new BufferedReader(new FileReader(hashfilename))) {
                     ...
                     for ( int j = 0; j < jarr.length(); j++) {
                        ...
                        String command = "git --git-dir ./CreateInputFiles/GitClones/" + path + "/.git " +
               ...
               String versionfilename = "CreateInputFiles/VersionInfoFiles/"+ token[0] + "VersionInfo.csv";
               ...
               String bugfilename = "../RQ3-RetrieveAV/CreateInputFiles/OrderedBugOutputFiles/"+ token[0] + "BugInfoOrdered.csv";
...
System.out.println("All kappas: " + kappaP0.toString() + " " + kappaP25.toString() + " " + kappaP50.toString() + " " + kappaP75.toString() + " " + kappaP100.toString());
               ...
               for ( i = (totalBugs / 2); i <= totalBugs ; i++) {
                  for (j = 1 ; j <= BugAndFix.get(i); j++) {
                     String simple, proportion0_5, proportion1, proportion2, merge, szz,szzB,szz0, szz25,szz50,szz75,szz100, actual;
                     if (j < BugAndAV.get(i) || j >= BugAndFix.get(i))
                        actual = "No";
                     else
                        actual = "Yes";
